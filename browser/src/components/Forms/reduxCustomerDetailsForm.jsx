  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <Field
            name="email1" component={TextField} hintText="Email 1"
            ref="name" withRef
          />
        </div>
        ...
        <div>
          <Field
            name="email2" component={TextField} hintText="Email 2"
            ref="name" withRef
          />
        </div>
        ...
        <div>
          <Field
            name="hphone" component={TextField} hintText="Home Phone"
            ref="name" withRef
          />
        </div>
        ...
        <div>
          <Field
            name="cphone" component={TextField} hintText="Cell Phone"
        ...
        <div>
          <Field
            name="wphone" component={TextField} hintText="Work Phone"
            ref="name" withRef
          />
        </div>
        <br />
