...
const pdfMakeEstimate = (customer, generics, prices, surveyPhotos, customText) => {
  ...
  // Build document
    ...
    footer: [
      horizontalLine(),
      { text: 'Three Little Pigs Masonry 14845 Yonge St., Unit 6, Suite 322, Aurora, ON, L4G 6H8', alignment: 'center' },
    ...
    content: { stack: [
     ...
     { text: 'Your Estimate Details:', style: 'details',  pageBreak: 'before' },
  ...
  function createSitePhotos(photos) {
   // console.log('photos', photos)
    ...
    { stack: [
      ...
      //  console.log('site', sitePhoto)
    return  { stack: [
                { image: sitePhoto, alignment: 'center', fit: [IMAGE_MAX_WIDTH, IMAGE_MAX_HEIGHT] },
        ],
          style: 'sitePhoto' }
